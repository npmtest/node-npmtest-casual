...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-casual/node_modules/casual/src/providers/internet.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-casual/node_modules/casual/src/providers/internet.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-casual/node_modules/casual/src/providers/</a> &#187; internet.js</div>
</div>
<div class="body">
...
&nbsp;
	free_email_domain: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.free_email_domains);</span>
	},
&nbsp;
	top_level_domain: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.top_level_domains);</span>
	},
&nbsp;
	domain: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.domain_formats);</span>
	},
&nbsp;
	email: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.email_formats);</span>
	},
&nbsp;
	url: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.url_formats);</span>
	},
&nbsp;
	ip: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return [this.integer(0, 255), this.integer(0, 255), this.integer(0, 255), this.integer(0, 255)].join('.');</span>
	},
&nbsp;
	user_agent: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.user_agents);</span>
	}
};
&nbsp;
