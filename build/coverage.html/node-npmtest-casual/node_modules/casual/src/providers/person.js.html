...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-casual/node_modules/casual/src/providers/person.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-casual/node_modules/casual/src/providers/person.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-casual/node_modules/casual/src/providers/</a> &#187; person.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var glues = ['.', '-', '_', null];
&nbsp;
var provider = {
	phone_formats: ['###-###-####'],
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.name_formats);</span>
	},
&nbsp;
	username: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.username_formats);</span>
	},
&nbsp;
	full_name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.full_name_formats);</span>
	},
&nbsp;
	first_name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.first_names);</span>
	},
&nbsp;
	last_name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.last_names);</span>
	},
&nbsp;
	password: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.numerify('#' + this.first_name + '##');</span>
	},
&nbsp;
	phone: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.numerify(this.random_element(this.phone_formats));</span>
	},
&nbsp;
	name_prefix: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.prefix);</span>
	},
&nbsp;
	name_suffix: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.suffix);</span>
	},
&nbsp;
	company_suffix: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.company_suffixes);</span>
	},
&nbsp;
	company_name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.populate_one_of(this.company_name_formats);</span>
	},
&nbsp;
	catch_phrase: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		var result = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		for (var i in this.catch_phrase_words) {</span>
<span class="cstat-no" title="statement not covered" >			result.push(this.random_element(this.catch_phrase_words[i]));</span>
		}
&nbsp;
