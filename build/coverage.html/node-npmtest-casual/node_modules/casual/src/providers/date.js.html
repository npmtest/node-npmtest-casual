...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-casual/node_modules/casual/src/providers/date.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-casual/node_modules/casual/src/providers/date.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-casual/node_modules/casual/src/providers/</a> &#187; date.js</div>
</div>
<div class="body">
...
&nbsp;
	unix_time: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.integer(0, moment().unix());</span>
	},
&nbsp;
	moment: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return moment.unix(this.unix_time);</span>
	},
&nbsp;
	date: <span class="fstat-no" title="function not covered" >function(format) {</span>
<span class="cstat-no" title="statement not covered" >		format = format || 'YYYY-MM-DD';</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format(format);</span>
	},
&nbsp;
	time: <span class="fstat-no" title="function not covered" >function(format) {</span>
<span class="cstat-no" title="statement not covered" >		format = format || 'HH:mm:ss';</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format(format);</span>
	},
&nbsp;
	century: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.centuries);</span>
	},
&nbsp;
	am_pm: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(['am', 'pm']);</span>
	},
&nbsp;
	day_of_year: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.dayOfYear();</span>
	},
&nbsp;
	day_of_month: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format('D');</span>
	},
&nbsp;
	day_of_week: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format('d');</span>
	},
&nbsp;
	month_number: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format('M');</span>
	},
&nbsp;
	month_name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format('MMMM');</span>
	},
&nbsp;
	year: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.moment.format('YYYY');</span>
	},
&nbsp;
	timezone: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return this.random_element(this.timezones);</span>
	}
};
&nbsp;
